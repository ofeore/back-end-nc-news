...
describe("GET /api/articles", () => {
  ...
  test("200: sorts articles by created_at in ascending order", () => {
    return request(app)
  ...
  test("200: sorts articles by comment_count ascending", () => {
    return request(app)
  ...
  test("400: bad request when sort_by is invalid", () => {
    return request(app)
